        ...
        return when (value) {
            ...
            is IrConstantObject -> {
                ...
                val fields = if (value.constructor.owner.isConstantConstructorIntrinsic) {
                    ...
                    // TODO: Remove
                    if (constructor.constructorImplFunction == null && constructor.body != null)
                        error("BUGBUGBUG: ${constructor.render()}")
    ...
    private inner class ReturnableBlockScope(val returnableBlock: IrReturnableBlock, val resultSlot: LLVMValueRef?) :
        ...
        private val functionScope by lazy {
            returnableBlock.inlineFunction?.let {
                // TODO: Should we really support inline constructors here?
                ((it as? IrSimpleFunction) ?: context.getConstructorImpl(it as IrConstructor))
                        .scope(file().fileEntry.line(generationState.inlineFunctionOrigins[it]?.startOffset ?: it.startOffset))
            }
        }
